...
android {
    namespace = "com.tristinbaker.lifeos"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.tristinbaker.lifeos"
        minSdk = 33
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation(project(":modules:lifeos_notes"))
    implementation(project(":modules:lifeos_habittracker"))
