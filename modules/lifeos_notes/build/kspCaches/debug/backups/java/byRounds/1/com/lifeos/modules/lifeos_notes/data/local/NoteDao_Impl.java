...
public final class NoteDao_Impl implements NoteDao {
  ...
  public NoteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNoteEntity = new EntityInsertionAdapter<NoteEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `lifeos_notes` (`id`,`title`,`content`,`isPinned`,`createdAt`,`updatedAt`,`notificationTime`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getNotificationTime() == null) {
          ...
          statement.bindLong(7, entity.getNotificationTime());
        }
      }
    };
    this.__deletionAdapterOfNoteEntity = new EntityDeletionOrUpdateAdapter<NoteEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "DELETE FROM `lifeos_notes` WHERE `id` = ?";
      }
    ...
    this.__updateAdapterOfNoteEntity = new EntityDeletionOrUpdateAdapter<NoteEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `lifeos_notes` SET `id` = ?,`title` = ?,`content` = ?,`isPinned` = ?,`createdAt` = ?,`updatedAt` = ?,`notificationTime` = ? WHERE `id` = ?";
      }
    ...
    this.__preparedStmtOfDeleteNoteById = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "DELETE FROM lifeos_notes WHERE id = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdatePinStatus = new SharedSQLiteStatement(__db) {
      ...
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE lifeos_notes SET isPinned = ?, updatedAt = ? WHERE id = ?";
        return _query;
      }
    };
    this.__preparedStmtOfUpdateNotificationTime = new SharedSQLiteStatement(__db) {
      ...
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE lifeos_notes SET notificationTime = ?, updatedAt = ? WHERE id = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object updatePinStatus(final long id, final boolean isPinned, final long updatedAt,
  ...
  @Override
  public Object updateNotificationTime(final long id, final Long notificationTime,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        ...
        if (notificationTime == null) {
          ...
          _stmt.bindLong(_argIndex, notificationTime);
        }
        _argIndex = 2;
        _stmt.bindLong(_argIndex, updatedAt);
        _argIndex = 3;
  ...
  public Flow<List<NoteEntity>> getAllNotes() {
    final String _sql = "SELECT * FROM lifeos_notes ORDER BY isPinned DESC, updatedAt DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"lifeos_notes"}, new Callable<List<NoteEntity>>() {
      @Override
      @NonNull
      public List<NoteEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new NoteEntity(_tmpId,_tmpTitle,_tmpContent,_tmpIsPinned,_tmpCreatedAt,_tmpUpdatedAt,_tmpNotificationTime);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  public Object getNoteById(final long id, final Continuation<? super NoteEntity> $completion) {
    final String _sql = "SELECT * FROM lifeos_notes WHERE id = ?";
      ...
      public NoteEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new NoteEntity(_tmpId,_tmpTitle,_tmpContent,_tmpIsPinned,_tmpCreatedAt,_tmpUpdatedAt,_tmpNotificationTime);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Flow<NoteEntity> getNoteByIdFlow(final long id) {
    final String _sql = "SELECT * FROM lifeos_notes WHERE id = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, id);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"lifeos_notes"}, new Callable<NoteEntity>() {
      @Override
      @Nullable
      public NoteEntity call() throws Exception {
        final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
  ...
  @Override
  public Object getNotesWithUpcomingNotifications(final long currentTime,
      final Continuation<? super List<NoteEntity>> $completion) {
    final String _sql = "SELECT * FROM lifeos_notes WHERE notificationTime IS NOT NULL AND notificationTime > ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
